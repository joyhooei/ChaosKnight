...
namespace DigitalRuby.RainMaker
{
        ...
        private void UpdateWind()
        {
            if (EnableWind && WindZone != null) //&& WindSpeedRange.y > 1.0f
            {
                ...
                if (nextWindTime < Time.time)
                {
                    ...
                    audioSourceWind.Play((WindZone.windMain / WindSpeedRange.z) * WindSoundVolumeModifier * PublicClass.music);
                }
            }
            else
            {
            ...
            if (lastRainIntensityValue != RainIntensity)
            {
                ...
                else
                {
                    ...
                    if (audioSourceRainCurrent != newSource)
                    {
                        ...
                        //audioSourceRainCurrent.AudioSource.maxVolume = PublicClass.music;
                        audioSourceRainCurrent.Play(PublicClass.music);
                    }
                    if (RainFallParticleSystem != null)
                    {
                        ParticleSystem.EmissionModule e = RainFallParticleSystem.emission;
    ...
    public class LoopingAudioSource
    {
        ...
        public LoopingAudioSource(MonoBehaviour script, AudioClip clip)
        {
            ...
            AudioSource.Stop();
            TargetVolume = PublicClass.music;
        }
        ...
        public void Update()
        {
            ...
            if (PublicClass.music == 0) AudioSource.volume = 0;
        }
    }
